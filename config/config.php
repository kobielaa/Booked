...
$conf['settings']['default.timezone'] = 'Europe/Warsaw';
$conf['settings']['allow.self.registration'] = 'false';
$conf['settings']['admin.email'] = 'mariusz.kobiela@altimi.com';
$conf['settings']['admin.email.name'] = 'Mariusz Kobiela';
$conf['settings']['default.page.size'] = '50';
$conf['settings']['enable.email'] = 'true';
$conf['settings']['default.language'] = 'en_us';
$conf['settings']['script.url'] = 'http://booked.altimi.dev/Web';
...
$conf['settings']['inactivity.timeout'] = '180';
$conf['settings']['name.format'] = '{first} {last}';
$conf['settings']['css.extension.file'] = '';
$conf['settings']['disable.password.reset'] = 'true';
$conf['settings']['home.url'] = 'http://booked.altimi.dev/Web';
$conf['settings']['logout.url'] = 'http://booked.altimi.dev/Web';
...
$conf['settings']['install.password'] = '5509708a04413';
...
$conf['settings']['email']['default.from.address'] = 'booked@altimi.com';
$conf['settings']['email']['default.from.name'] = 'Booked';
